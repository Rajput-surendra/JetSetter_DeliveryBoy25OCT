...
import 'package:deliveryboy_multivendor/Screens/Authentication/Login/LoginScreen.dart';
...
class _SignUpState extends State<SignUp> with TickerProviderStateMixin {
  ...
  final zipcodeLabelController = TextEditingController();
  ...
  _scrollListener() {
    if (context.read<ZipcodeListProvider>().controller.offset >=
            context
                .read<ZipcodeListProvider>()
                .controller
                .position
                .maxScrollExtent &&
        !context.read<ZipcodeListProvider>().controller.position.outOfRange) {
      if (this.mounted) {
        setState(
          () {
            context.read<ZipcodeListProvider>().isLoadingmore = true;

            if (context.read<ZipcodeListProvider>().offset <
                context.read<ZipcodeListProvider>().total)
              context
                  .read<ZipcodeListProvider>()
            ...
            children: [
              ...
              Padding(
                ...
                child: Container(
                  ...
                  child: ListTile(
                    title: Text(
                        getTranslated(context, 'SERVICEABLE_ZIPCODE_LBL')!),
                                                                  ...
                                                                  return data
                                                                      ...
                                                                      .map((index,
                                                                          ...
                                                                          MapEntry(
                                                                              index,
                                                                              CheckboxListTile(
                                                                                title: Text(element.zipcode!),
                                                                                value: selectedZipcodeList.contains(element.zipcode),
                                                                                //value: true,
                                                                                onChanged: (_) {
