...
const Color primary = Color(0xff23C0A9);
const Color secondary = Color(0xff23C0A9);
const Color fontColor = Color(0xff4543C1);
const Color grad1Color = Color(0xff23C0A9);
const Color grad2Color = Color(0xff23C0A9);
